...
is_pipeline() {
    ...
    for required in agy-worker.sh qa-gate.sh verify-job.sh evidence-report.sh benchmark.sh persona-evidence.sh model-recommendation.sh model-selection.sh doctor.sh; do
