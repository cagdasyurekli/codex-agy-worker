...
| `docs/ROADMAP.md` | Dependency-ordered product slices with explicit implemented or deferred status, historical v0.2.0 and v0.4.0 scope, plus the v0.5.0 feedback release scope represented by this source; source, tests, and README remain current-behavior authority, while tag/release state remains separately verifiable | human review; implementation claims remain prohibited until their slices land |
