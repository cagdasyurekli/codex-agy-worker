...
make_fixture() {
    ...
    printf '%s\n' '#!/usr/bin/env bash' \
        ...
        '  ready) printf "agy 1.2.11\\n" ;;' \
        '  bare) printf "1.2.11\\n" ;;' \
        '  no-newline) printf "agy 1.2.11" ;;' \
        '  two-newlines) printf "agy 1.2.11\\n\\n" ;;' \
        '  carriage-return) printf "agy 1.2.11\\r\\n" ;;' \
        '  control) printf "agy 1.2.11\\t" ;;' \
        '  nul) printf "agy 1.2.11\\0" ;;' \
        '  prefix-junk) printf "version: agy 1.2.11\\n" ;;' \
