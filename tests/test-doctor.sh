...
make_fixture() {
    ...
    printf '%s\n' '#!/usr/bin/env bash' \
        ...
        '    no-newline) printf "1.2.7"; exit 0 ;;' \
        '    multiline) printf "1.2.7\\nextra\\n"; exit 0 ;;' \
    ...
    printf '%s\n' '#!/usr/bin/env bash' \
        ...
        '  ready) printf "agy 1.2.7\\n" ;;' \
        '  bare) printf "1.2.7\\n" ;;' \
        '  no-newline) printf "agy 1.2.7" ;;' \
        '  two-newlines) printf "agy 1.2.7\\n\\n" ;;' \
        '  carriage-return) printf "agy 1.2.7\\r\\n" ;;' \
        '  control) printf "agy 1.2.7\\t" ;;' \
        '  nul) printf "agy 1.2.7\\0" ;;' \
        '  prefix-junk) printf "version: agy 1.2.7\\n" ;;' \
