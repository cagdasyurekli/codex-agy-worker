...
make_fixture() {
    ...
    printf '%s\n' '#!/usr/bin/env bash' \
        ...
        '    no-newline) printf "1.2.2"; exit 0 ;;' \
        '    multiline) printf "1.2.2\\nextra\\n"; exit 0 ;;' \
    ...
    printf '%s\n' '#!/usr/bin/env bash' \
        ...
        '  bare) printf "1.2.2\\n" ;;' \
        '  no-newline) printf "agy 1.2.2" ;;' \
        '  two-newlines) printf "agy 1.2.2\\n\\n" ;;' \
        '  carriage-return) printf "agy 1.2.2\\r\\n" ;;' \
        '  control) printf "agy 1.2.2\\t" ;;' \
        '  nul) printf "agy 1.2.2\\0" ;;' \
        '  prefix-junk) printf "version: agy 1.2.2\\n" ;;' \
