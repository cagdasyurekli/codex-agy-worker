...
make_fixture() {
    ...
    printf '%s\n' '#!/usr/bin/env bash' \
        ...
        '    no-newline) printf "1.1.27"; exit 0 ;;' \
        '    multiline) printf "1.1.27\\nextra\\n"; exit 0 ;;' \
    ...
    printf '%s\n' '#!/usr/bin/env bash' \
        ...
        '  ready) printf "agy 1.1.27\\n" ;;' \
        '  bare) printf "1.1.27\\n" ;;' \
        '  no-newline) printf "agy 1.1.27" ;;' \
        '  two-newlines) printf "agy 1.1.27\\n\\n" ;;' \
        '  carriage-return) printf "agy 1.1.27\\r\\n" ;;' \
        '  control) printf "agy 1.1.27\\t" ;;' \
        '  nul) printf "agy 1.1.27\\0" ;;' \
        '  prefix-junk) printf "version: agy 1.1.27\\n" ;;' \
