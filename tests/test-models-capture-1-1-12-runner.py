#!/usr/bin/env python3
"""Offline capture-runner slice of the 1.1.12 capture bridge tests."""
...
if __name__ == "__main__":
    all_tests = unittest.defaultTestLoader.getTestCaseNames(MODULE["ModelsCapture112Tests"])
    suite = unittest.TestSuite(
        MODULE["ModelsCapture112Tests"](name) for name in all_tests if name not in PROFILE_TESTS
    )
