#!/usr/bin/env python3
"""Process-inert profile preparation for the separately authorized 1.1.22 capture.
...
MODULE_AST_SHA256 = "6dcc38545431617009600b971c73be750be4080dcf21795ff6911f4c4ec3ac70"
...
def _validate_recovery(root: str, source_path: str, source: FileIdentity, snapshot: FileIdentity) -> None:
    ...
    try:
        ...
        if (binding.get("claim") != "snapshot-version-only" or not isinstance(source_value, dict) or not isinstance(snapshot_value, dict) or not isinstance(version_value, dict)
                ...
                or version_value.get("logical_argv") != [source_path, "--version"] or version_value.get("expected") != "1.1.22" or version_value.get("observed") != "1.1.22" or version_value.get("exit") != 0 or version_value.get("popen_count") != 1
