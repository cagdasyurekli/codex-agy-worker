...
The local development candidate's active baseline is agy `1.2.2` at official release
commit `ba985e6b5de2ac8aa09860a154a102831eb7722b`; its accepted inventory is reconciled in
[`reviews/agy-1.2.2-activation.md`](reviews/agy-1.2.2-activation.md). Earlier
...
`agy-distribution-manifest.json` records the observed `1.2.2` version, exact Google
...
metadata. The separately authorized 1.2.2 capture and human reconciliation advance
the active version, release binding, inventory, and matrix only through
[`reviews/agy-1.2.2-activation.md`](reviews/agy-1.2.2-activation.md). Neither record
